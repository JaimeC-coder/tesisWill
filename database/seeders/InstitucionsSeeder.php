...
class InstitucionsSeeder extends Seeder
{
    ...
    {
        $institucions = [
            [1, '0444240-0', '0', 'PRIMARIA', '82857 Lives', 'PÚBLICA', '6', '194', '1844', 'AV. SAN MIGUEL S/N', 'DRE CAJAMARCA', 'UGEL SAN MIGUEL', 'MIXTO', 'MAÑANA', 'LUNES - VIERNES', 'PAUCAR IGNACIO, YMELDA AFRODICIA', '456789', NULL, NULL]
        ];
