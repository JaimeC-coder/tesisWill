...
<head>
  ...
  <!-- progress barstle -->
  <link rel="stylesheet" href={{ asset('landing/css/css-circular-prog-bar.css')}} />
  <!-- fonts style -->
    ...
    <section class="hero_section ">
      <div class="hero-container container">
        ...
        <div class="hero_img-container">
          <div>
            <img src={{ asset('landing/images/hero.png')}} alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="about_img-container">
              <img src={{ asset('landing/images/about.png')}} alt="">
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="admission_img-container">
              <img src={{ asset('landing/images/admission.png')}} alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="why_img-container">
              <img src={{ asset('landing/images/why.png')}} alt="">
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="determine_img-container">
              <img src={{ asset('landing/images/determine.png')}} alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="contact_img-box">
                <img src={{ asset('landing/images/students.jpg')}} alt="">
              </div>
            </div>
          </div>
        </div>
