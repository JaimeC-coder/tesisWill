...
function searchInformation(){
    ...
    .then(data => {
        ...
        if(data && data.success){
            ...
            dni.value =data.dni || "";
            pais.value="Perú";
            email.value=data.nombres.charAt(0).toLowerCase() +data.apellidoPaterno.toLowerCase()+"@colegio.com";
            emailhidden.value=data.nombres.charAt(0).toLowerCase() +data.apellidoPaterno.toLowerCase()+"@colegio.com";
            email.disabled=true;
            emailcorreo.value=data.nombres.charAt(0) +data.apellidoPaterno+"@colegio.com";
            ...
            if(data.per_email == null){
                ...
                email.value=data.per_nombres.charAt(0).toLowerCase() +data.per_apellidos.split(" ")[0].toLowerCase()+"@colegio.com";
                email.disabled=true;
                emailcorreo.value=data.per_nombres.charAt(0).toLowerCase() +data.per_apellidos.split(" ")[0].toLowerCase()+"@colegio.com";
                emailcorreo.disabled=true;
                emailhidden.value=data.per_nombres.charAt(0).toLowerCase() +data.per_apellidos.split(" ")[0].toLowerCase()+"@colegio.com";
